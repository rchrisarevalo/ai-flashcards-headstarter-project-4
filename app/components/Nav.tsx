      ...
      {!auth?.isSignedIn ? (
        <ul className="flex flex-row justify-center p-2 gap-10">
          <li className="p-3 max-sm:hidden group">
            <Link href="/login" className="relative inline-block">Sign In
          ...
          <li className="p-3 max-sm:hidden group">
            <Link href="/signup" className="relative inline-block">Sign Up
              <span className="absolute bottom-0 left-0 w-full h-1 bg-blue-500 transform scale-x-0 transition-transform duration-300 group-hover:scale-x-100"></span></Link>
        ...
        <ul className="flex flex-row space-between p-2 gap-10">
          <li className="p-3 group">
            <Link href="/dashboard" className="relative inline-block"> My Dashboard
              <span className="absolute bottom-0 left-0 w-full h-1 bg-blue-500 transform scale-x-0 transition-transform duration-300 group-hover:scale-x-100"></span></Link>
          </li>
          <li className="p-3 group">
            <Link href="/dashboard/flashcards" className="relative inline-block"> Generate New Set
              <span className="absolute bottom-0 left-0 w-full h-1 bg-blue-500 transform scale-x-0 transition-transform duration-300 group-hover:scale-x-100"></span></Link>
          </li>
          <li className="p-3 group">
